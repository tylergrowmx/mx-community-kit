(function (global, factory) {
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$c(fn = input.toString) && !isObject$3(val = call$7(fn, input))) return val;
	  if (isCallable$c(fn = input.valueOf) && !isObject$3(val = call$7(fn, input))) return val;
	  if (pref !== 'string' && isCallable$c(fn = input.toString) && !isObject$3(val = call$7(fn, input))) return val;
	...
	if (NATIVE_WEAK_MAP || shared$1.state) {
	  ...
	  var wmget = uncurryThis$8(store$1.get);
	  var wmhas = uncurryThis$8(store$1.has);
	  var wmset = uncurryThis$8(store$1.set);
	...
	*/
	...
	mxStores.prod.runMX = () => {
	  try {
	    ...
	    const rs = typeof resourcesDropdown !== "undefined" ? resourcesDropdown : defaultResourcesDropdown;
	    ...
	    const hideReplaced = () => ["a.header-navigation_link.title-mx-docs", "a.header-navigation_link.title-support", "a.header-navigation_link.title-mx-academy"].forEach(sel => {
